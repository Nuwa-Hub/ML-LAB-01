# -*- coding: utf-8 -*-
"""ml-lab1-label2-190458t.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17Df-Gbvlo5XVxCW8i1eB_dekmuAsHGXN
...
mse = mean_squared_error(test_label2_copy, y_pred_base_test)
r2s = r2_score(test_label2_copy, y_pred_base_test)

print(f"Metrics for KNeighborsRegressor on test data:")
print(f"Mean Squared Error: {mse:.2f}")
print(f"R2 Score: {r2s:.2f}")
print("\n")
...
test_features = test_features.loc[:,train_features.var() > variance_threshold]
...
for model_name, model in classification_models:
    ...
    # Calculate metrics for classification evaluation on test data
    mse = mean_squared_error(test_label2, y_pred_test)
    r2s = r2_score(test_label2, y_pred_test)
