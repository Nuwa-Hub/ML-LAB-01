# -*- coding: utf-8 -*-
"""ml-lab1-label3-190458t.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SuZBNYEHVfpRnGpSU2J0_QvrRKcEqPtc
...
accuracy = accuracy_score(test_label3_copy, y_pred_base_test)
precision = precision_score(test_label3_copy, y_pred_base_test, average='weighted', zero_division=1)
recall = recall_score(test_label3_copy, y_pred_base_test, average='weighted')
...
for model_name, model in classification_models:
    ...
    # Calculate metrics for classification evaluation on test data
    accuracy = accuracy_score(test_label3, y_pred_test)
    precision = precision_score(test_label3, y_pred_test, average='weighted', zero_division=1)
    recall = recall_score(test_label3, y_pred_test, average='weighted')
...
def create_csv(features, pred_before_fe, pred_after_fe):
  ...
  df.to_csv('/kaggle/working/190458T_label_3.csv', index=False)
